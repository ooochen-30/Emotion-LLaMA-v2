...
class COCOVQADataset(VQADataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        ...
        self.vis_root = "/home/user/big_space/datasets/General/MSCOCO/utils/refer-master/data/images/mscoco"
        ...
        for ann in self.annotation:
            ...
            # print(f"""image_path:{image_path}, self.vis_root:{self.vis_root}, ann["image"]:{ann["image"]}""")
            if os.path.exists(image_path):
                exist_annotation.append(ann)
        self.annotation = exist_annotation
        print("COCOVQADataset exist_annotation: ",len(exist_annotation))
    ...
    def __getitem__(self, index):
        ...
        instruction = "<Vid><VideoHere></Vid> {} ".format(instruction)
